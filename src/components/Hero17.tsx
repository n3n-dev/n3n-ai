...
export default function Hero17({ lang, h1Override, subheadOverride }: Props) {
  const h1 =
    h1Override ??
    (lang === 'ko'
      ? 'From Video\nto Decisions'
  ...
  const colBg =
    ...
    'rgba(254,243,199,0.85) 54%,' +
    'rgba(253,224,71,0.72) 64%,' +
    'rgba(250,204,21,0.45) 74%,' +
    'rgba(217,160,8,0.22) 82%,' +
    'rgba(180,120,4,0.08) 90%,' +
    'rgba(120,80,0,0) 100%)'
    ...
    <section className="relative overflow-hidden bg-[#000000] text-white isolate">
                ...
                return (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      style={{
                        background:
                          'linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(200,226,197,0.55) 40%, rgba(255,255,255,0.92) 60%, rgba(254,243,199,0.55) 80%, rgba(0,0,0,0) 100%)',
                        mixBlendMode: 'screen',
                        filter: 'blur(2px)',
                      }}
                      initial={{ y: '-120%' }}
        ...
        {drops.map((d) => (
          <motion.span
            ...
            style={{
              ...
              height: `${d.heightPct}%`,
              background:
                'linear-gradient(to bottom, rgba(254,243,199,0) 0%, rgba(253,224,71,0.45) 35%, rgba(255,255,255,0.95) 70%, rgba(200,226,197,0.55) 100%)',
              filter: 'blur(0.5px)',
              opacity: d.opacity,
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-10 pt-44 md:pt-60 pb-44 md:pb-60 min-h-[88vh] flex flex-col justify-center">
        ...
        <motion.p
          ...
          className="mt-10 md:mt-14 text-[13px] md:text-base lg:text-lg leading-[1.45] tracking-tight text-white/80 text-center mx-auto break-keep whitespace-normal md:whitespace-nowrap max-w-[92%] md:max-w-none"
        >
          {sub}
        </motion.p>
      </div>
