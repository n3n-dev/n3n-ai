                ...
                return (
                  <motion.div
                    ...
                    animate={
                      reduce
                        ? { scaleY: 1 }
                        : { scaleY: [0.92, 1.04, 0.94, 1.0, 0.92] }
                    }
                    transition={
                      reduce
                        ? { duration: 0 }
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      animate={
                        reduce
                          ? { opacity: 0.6 }
                          : { opacity: [0.45, 0.9, 0.55, 0.95, 0.45] }
                      }
                      transition={
                        reduce
                          ? { duration: 0 }
      ...
      >
        {drops.map((d) => (
          <motion.span
            ...
            initial={{ y: "-120%" }}
            animate={reduce ? { y: "-120%" } : { y: ["-120%", "1400%"] }}
            transition={
              reduce
                ? { duration: 0 }
                : {
