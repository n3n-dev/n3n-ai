...
export default function ConnectedXSection({ lang }: Props) {
  ...
  // Lazy-mount the actual <source> only once the section is within ~200px
  // of the viewport. Avoids eagerly downloading the 9.4MB hero-video-4.mp4
  // when the user lands at the top of the page.
  const sectionRef = useRef<HTMLElement>(null);
  // Lazy initializer: if SSR or no IntersectionObserver, load immediately.
  // This avoids the setState-in-effect cascade for the fallback branch.
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-black py-12 md:py-14 overflow-hidden"
    >
