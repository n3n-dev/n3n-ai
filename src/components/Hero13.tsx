...
// Draft 13 hero — Hero12 animation engine, colors retuned to the
// reference screenshot, full-height center glow line removed, fine
...
export default function Hero13({ tr, lang, h1Override, subheadOverride }: Props) {
  const h1 =
    h1Override ??
    (lang === 'ko'
      ? 'Decisions,\nin real time.'
              ...
              {Array.from({ length: COLS }).map((_, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* center vertical highlight strip — gives the rounded
                        glass feel */}
                    <div
                      className="absolute inset-0 pointer-events-none"
                      style={{ background: cylinderHighlight, mixBlendMode: 'screen' }}
                    />
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                ...
                style={{
                  ...
                  border: '1px solid rgba(160,228,218,0.40)',
                  color: '#F2FFFA',
                  backdropFilter: 'blur(6px)',
                  boxShadow:
                    '0 0 18px rgba(78,184,181,0.20), inset 0 1px 0 rgba(255,255,255,0.20)',
                }}
              >
                {tr.hero.cta1}
