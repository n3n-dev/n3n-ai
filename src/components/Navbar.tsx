...
// to come back up.
const HERO_ONLY_ROUTES = new Set<string>(['/draft0-5', '/draft0-2', '/draft0-3'])
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-[1fr_auto_1fr] items-center h-16 md:h-20 pt-1 md:pt-2 gap-2 md:gap-4">
        ...
        {onCompany ? (
          ...
          <Link to="/" className="flex items-center justify-center group" aria-label="N3N Home">
            <img
              src={`${import.meta.env.BASE_URL}logo-n3n.png`}
              alt="N3N"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden fixed inset-0 z-40 bg-[#050A18]/98 backdrop-blur-md"
          >
