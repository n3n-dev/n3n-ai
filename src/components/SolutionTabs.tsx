...
const INNOWATCH_CARDS: FeatureCard[] = [
 {
  ...
  heading: { ko: '직관적인 디스플레이 월 운영', en: 'Intuitive display wall operation' },
  body: {
 ...
 },
 {
  ...
  heading: { ko: 'MAP 상의 모든 카메라 실시간 재생', en: 'Every camera on the map, always live' },
  body: {
 ...
 },
 {
  ...
  heading: { ko: '유연한 맵·비디오 데이터 통합', en: 'Flexible map and video data integration' },
  body: {
  ...
  heading2: { ko: 'i-Editor를 통한 맞춤형 디스플레이', en: 'Custom layouts via i-Editor' },
  body2: {
 ...
 },
 {
  ...
  heading: { ko: '지능형 데이터 프로세싱', en: 'Intelligent data processing' },
  body: {
 ...
 },
 {
  ...
  heading: { ko: 'RDS, Remote Desktop System', en: 'RDS, Remote Desktop System' },
  body: {
...
export default function SolutionTabs({ tr: _tr, lang, bg = 'cream', h2Override, variant = 'default' }: Props) {
  ...
  variant === 'draft20'
   ? INNOWATCH_CARDS.map((card, i) => {
     if (i === 0) {
      return {
       ...card,
       heading: { ko: '통합 디스플레이 관제', en: 'Unified display control' },
       body: {
     ...
     if (i === 1) {
      return {
       ...card,
       heading: { ko: '실시간 맵 기반 영상 모니터링', en: 'Real-time map-based video monitoring' },
       body: {
       ...
       heading2: { ko: '대규모 영상 데이터 처리', en: 'Large-scale video data processing' },
       body2: {
     ...
     if (i === 2) {
      return {
       ...card,
       heading: { ko: '유연한 맵·영상 데이터 통합', en: 'Flexible map and video data integration' },
       body: {
       ...
       bullets: undefined,
       heading2: { ko: '맞춤형 운영 UI 구성', en: 'Custom operations UI' },
       body2: {
     ...
     if (i === 3) {
      return {
       ...card,
       heading: { ko: '유연한 시스템 확장', en: 'Flexible system scaling' },
       body: {
       ...
       heading2: { ko: '효율적인 운영 환경 구성', en: 'Efficient operating environment' },
       body2: {
     ...
     if (i === 4) {
      return {
       ...card,
       heading: { ko: 'AI 기반 데이터 통합 분석', en: 'AI-driven data integration & analysis' },
       body: {
       ...
       heading2: { ko: '맞춤형 운영 모니터링', en: 'Tailored operations monitoring' },
       body2: {
     ...
     if (i === 5) {
      return {
       ...card,
       heading: { ko: '원격 운영 및 제어 시스템', en: 'Remote operations & control system' },
       body: {
       ...
       heading2: { ko: '통합 원격 운영 환경', en: 'Unified remote operations environment' },
       body2: {
  ...
  variant === 'draft20'
   ? WIZEYE_CARDS.map((card, i) => {
     if (i === 0) {
      return {
       ...card,
       heading: { ko: '실시간 데이터 시각화', en: 'Real-time data visualization' },
       body: {
     ...
     if (i === 1) {
      return {
       ...card,
       heading: { ko: '실시간 운영 모니터링', en: 'Real-time operations monitoring' },
       body: {
     ...
     if (i === 3) {
      return {
       ...card,
       heading: { ko: '실시간 운영 상태 시각화', en: 'Real-time operational status visualization' },
       body: {
     ...
     if (i === 4) {
      return {
       ...card,
       heading: { ko: '실시간 협업 리포트', en: 'Real-time collaborative reporting' },
       body: {
 ...
 // Reset active card when switching product tabs
 useEffect(() => {
  setActiveIdx(0)
 }, [activeKey])
 ...
 return (
  <section className="relative w-full" style={{ background: sectionBg }}>
   ...
   <div className="relative mx-auto max-w-[1280px] px-6 md:px-10 pt-24 md:pt-32 pb-12 md:pb-[72px]">
    ...
    <div
     className="mt-12 md:mt-14 block md:flex md:flex-row md:gap-3 md:items-stretch"
    >
          ...
          >
           ...
           <div
            ...
            style={{
             ...
             maxWidth: variant === 'draft20' ? `${(200 * 16) / 9}px` : `${(240 * 16) / 9}px`,
            }}
           >
