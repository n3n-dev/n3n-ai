...
export default function Hero7({ tr, hideCta, badgeOverride, h1Override, subheadOverride }: Props) {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-24 right-6 md:right-10 z-10 flex items-center gap-2 px-3 py-1.5 rounded-full border border-red-400/40 bg-red-500/10 text-red-300 text-[10px] md:text-xs font-semibold tracking-[0.25em] uppercase"
      >
      ...
      >
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded border border-blue-400/30 bg-blue-500/10 text-blue-300 text-[10px] md:text-xs font-semibold tracking-[0.25em] uppercase mb-6 md:mb-8"
        >
        ...
        <motion.h1
          ...
          className="text-[30px] sm:text-[40px] md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.15] tracking-tight mb-6 whitespace-pre-line break-keep drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)]"
        >
        ...
        <motion.p
          ...
          className="text-sm md:text-base lg:text-lg text-gray-300/90 max-w-2xl mx-auto leading-relaxed whitespace-pre-line break-keep px-2"
        >
