...
// Draft 15 — flat-3D variant: no cylindrical edge shading, crisp
// per-column center highlight, SVG grain overlay on columns.
export default function Draft15Page({ tr, lang }: Props) {
  return (
    <>
      <VideoIntroOverlay
      ...
      <DraftSwitcher theme="light" active="Draft 15" />
      <Hero15 tr={tr} lang={lang} />
