import Hero112 from '../components/Hero112'
...
// Draft 11-2 — Tirtus-inspired corporate navy/cobalt blue light system.
// Same body scaffolding as Draft 11 (Industries → ConnectedX → UseCases)
// with a deeper, more enterprise-presentational hero.
export default function Draft112Page({ tr, lang }: Props) {
  return (
    <main style={{ background: '#FFFFFF', color: '#0F1F4F' }}>
      <DraftSwitcher theme="dark" active="Draft 11-2" />
      <Hero112 tr={tr} lang={lang} />
