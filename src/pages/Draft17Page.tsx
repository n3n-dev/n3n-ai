...
// Draft 17 — Draft 16 with sky-blue / white / yellow column palette.
export default function Draft17Page({ tr, lang }: Props) {
  return (
    <>
      <VideoIntroOverlay
      ...
      <Hero17 tr={tr} lang={lang} />

      <div className="relative z-10">
        <PlatformOverview lang={lang} bg="cream" />
        <SolutionTabs tr={tr} lang={lang} />
      </div>
