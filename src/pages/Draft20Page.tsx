            ...
            lang === "ko"
              ...
              : [
                  [
                    ...
                    "Real-time city operations KPIs",
                  ],
                  [
                    "Enhanced AI anomaly detection",
                    "Unified security control API",
                  ],
                  [
                    "Expand Predictive Maintenance",
                    "Optimize edge AI inference",
                  ],
                  [
                    "Thermal-based unified monitoring",
                    "Predictive fault response",
                  ],
                  [
                  ...
                  [
                    ...
                    "Drone & vessel unified dashboard",
                  ],
                ]
          }
        />
