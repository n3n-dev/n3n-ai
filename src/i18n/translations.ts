...
const ko: Translations = {
  ...
  hero: {
    ...
    h1: "운영 인텔리전스로\n기업을 혁신하세요",
    subhead:
      "전례 없는 속도와 정확도로 데이터를 감지하고, 분석하고, 실행합니다",
  ...
  industries: {
    ...
    items: [
      {
        title: "스마트시티",
        desc: "도시 전역의 교통·환경·안전 데이터를 통합 관제하고, 이상 징후를 즉각 감지하여 시민 안전을 강화합니다.",
      },
      {
        title: "SOC (보안관제)",
        desc: "수천 대 카메라 영상을 AI로 실시간 분석하여, 침입·이상행동을 자동 탐지하고 즉각 대응합니다.",
      },
      {
        title: "스마트 팩토리",
        desc: "생산 라인의 불량·설비 이상을 실시간 감지하고, 예측 정비로 가동률을 극대화합니다.",
      },
      {
        title: "에너지·플랜트",
        desc: "원격 설비 모니터링과 열화상 분석으로 안전 사고를 예방하고 운영 효율을 높입니다.",
      },
      {
        title: "데이터센터",
        desc: "서버룸 환경 감시, 출입 통제, 장비 상태를 통합 관제하여 무중단 운영을 지원합니다.",
      },
      {
        title: "교통·물류",
        desc: "차량·드론·선박의 실시간 위치와 영상을 통합하여, 물류 흐름을 최적화하고 사고를 예방합니다.",
      },
    ],
  },
  about: {
    ...
    cards: [
      {
        title: "클라우드 네이티브",
        desc: "클라우드 네이티브 설계로 무한한 확장성",
      },
      { title: "엣지 AI 처리", desc: "엣지 AI로 10ms 미만 지연의 실시간 분석" },
      {
        title: "엔터프라이즈 보안",
        desc: "SOC2 Type II 인증, 제로 트러스트 기반의 엔터프라이즈 보안",
      },
      {
        title: "즉시 배포",
        desc: "몇 시간 안에 온보딩부터 프로덕션까지 완전 관리형 배포",
      },
    ],
  },
  connecting: {
    ...
    phases: [
      {
        title: "Phase 1",
        desc: "글로벌 기업(Cisco 등) 대상 검증된 B2B 플랫폼. 엔터프라이즈급 실시간 영상 통합 인프라를 제공합니다.",
      },
      {
        title: "Phase 2",
        desc: "차량, 드론, 선박, 스마트시티, 저궤도 위성, 5G/LTE 등 이동하는 모든 디바이스를 연결하는 지능형 인프라스트럭처로 확장.",
      },
    ],
  },
  opint: {
    ...
    cases: [
      {
        ...
        category: "물류",
        desc: "항만 Logistics 운영정보와 IoT 데이터를 통합 시각화하여 4,000+ 자율 센서 노드의 원격 모니터링 및 운영 자동화를 실현했습니다.",
        image:
          "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=600&q=80",
        url: "https://n3n.co.kr/ko/psa",
      },
      {
        client: "Barcelona Smart Grid",
        category: "도시 운영",
        desc: "Smart Alarm Intelligence를 배치하여 IoT 노이즈 캔슬레이션으로 오경보 발송 비용을 30% 절감했습니다.",
        image:
          "https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=600&q=80",
        url: "https://n3n.co.kr/usecase",
      },
      {
        client: "Global Edge: 데이터 주권",
        category: "데이터센터",
        desc: "14개 주권 데이터 허브에 DTG 프로토콜을 구현하여 고우선순위 패킷 무결성을 보장합니다.",
        image:
      ...
      },
      {
        client: "제약 H사",
        category: "생산공정",
        desc: "GMP 공정 시각화로 일탈 관리 및 실시간 온도/습도/차압 관리",
        image:
          "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5581&lang=ko",
      },
      {
        client: "POSCO",
        category: "생산공정",
        desc: "Big Data 기반 실시간 Industrial IoT 데이터 시각화로 글로벌 운영 실현",
        image:
          "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5582&lang=ko",
      },
      {
        client: "H반도체",
        category: "생산공정",
        desc: "Wafer Big Data 맵과 연동된 공정 시각화로 예측 정비와 실시간 불량 원인 파악",
        image:
          "https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5583&lang=ko",
      },
      {
        client: "AT&T Mission Control",
        category: "서비스 운영",
        desc: "통신사 고객의 IoT Device 이용 정보를 통합 시각화한 IoT Management Platform 구현",
        image:
          "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5437&lang=ko",
      },
      {
        client: "AT&T Mexico",
        category: "서비스 운영",
        desc: "기지국의 센서 데이터, CCTV 정보 통합 시각화로 24/7/365 무인 원격 모니터링",
        image:
          "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5440&lang=ko",
      },
      {
        client: "Carnival Cruise",
        category: "서비스 운영",
        desc: "고객경험품질(QoE)의 시각화로 고객 맞춤형 IoT 서비스를 위한 실시간 데이터 통제력 확보",
        image:
          "https://images.unsplash.com/photo-1548574505-5e239809ee19?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5446&lang=ko",
      },
      {
        client: "인도 자이푸르",
        category: "스마트시티",
        desc: "공공인프라 정보 통합 모니터링으로 실시간 원격 운영체계 구현",
        image:
          "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5548&lang=ko",
      },
      {
        client: "마이애미 데이드",
        category: "스마트시티",
        desc: "실시간 통합 행정 KPI를 바탕으로 투명/효율성을 재고할 수 있는 스마트시티 플랫폼",
        image:
          "https://images.unsplash.com/photo-1514924013411-cbf25faa35bb?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5542&lang=ko",
      },
      {
        client: "송도 국제업무지구",
        category: "스마트시티",
        desc: "다양한 도시 운영 시나리오와 시각화된 IoT Data를 융합한 스마트시티 운영 솔루션",
        image:
          "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5555&lang=ko",
      },
      {
        client: "Cisco ITRM",
        category: "IT 인프라",
        desc: "복잡한 IT인프라를 인과관계에 기반한 논리 MAP으로 시각화하여 문제 원인 즉시 파악",
        image:
          "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5563&lang=ko",
      },
      {
        client: "H자동차",
        category: "산업현장",
        desc: "불꽃감지 센서 데이터와 실시간 영상 통합으로 화재 예방 시스템 구축",
        image:
          "https://images.unsplash.com/photo-1565043666747-69f6646db940?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5426&lang=ko",
      },
      {
        client: "POSCO ICT",
        category: "산업현장",
        desc: "생산 현장의 실시간 Full HD 화면을 중앙 관제실에서 원격 모니터링",
        image:
          "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5420&lang=ko",
      },
      {
        client: "S시 메트로",
        category: "공공인프라",
        desc: "지하철 운영 상황 및 시설물의 원격/지능형 관리를 위한 Smart Connected Subway 구현",
        image:
          "https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5371&lang=ko",
      },
      {
        client: "한국남동발전",
        category: "공공인프라",
        desc: "1,500대 이상의 CCTV와 센서 데이터 통합으로 네트워크 비용 및 유지보수비 절감",
        image:
          "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5367&lang=ko",
      },
      {
        client: "인천대교",
        category: "공공인프라",
        desc: "CCTV, 맵, 데이터, 기상 정보, 감지/제어 시스템의 통합으로 교통상황 통합 모니터링",
        image:
          "https://images.unsplash.com/photo-1545893835-abaa50cbe628?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5381&lang=ko",
      },
    ],
  },
  tech: {
  ...
  vision: {
    ...
    steps: [
      {
        title: "수집",
        desc: "카메라, IoT 센서, 데이터 스트림 등 모든 소스를 연결. INNOWATCH와 WIZEYE가 가시적·비가시적 데이터를 동시에 수집합니다.",
      },
      {
        title: "분석",
        desc: "AI 비전 엔진이 영상 스트림을 실시간으로 처리, 객체, 행동, 이상을 감지하며 IoT 빅데이터를 구조화된 인사이트로 변환합니다.",
      },
      {
        title: "통합",
        desc: "N3N Operation Intelligence 코어가 INNOWATCH와 WIZEYE의 데이터를 하나의 통합 인텔리전스 레이어로 융합합니다.",
      },
      {
        title: "실행",
        desc: "자동화된 워크플로우가 알림, 복구, 비즈니스 프로세스 앱을 트리거, 인간 개입 없이 즉각적인 행동 가능한 통찰을 제공합니다.",
      },
    ],
    stats: [
  ...
  decision: {
    ...
    features: [
      {
        title: "Rules Engine",
        desc: "운영 규칙에 따라 상황을 분류하고 우선순위를 매깁니다.",
      },
      {
        title: "Real-time Alerts",
        desc: "담당자에게 정확한 맥락의 알림을 즉시 전달합니다.",
      },
      {
        title: "Automated Actions",
        desc: "사전 정의된 대응 절차를 자동으로 실행합니다.",
      },
    ],
    outputs: [
      "Incident Detection",
...
const en: Translations = {
  ...
  hero: {
    ...
    subhead:
      "Detect, analyze, and act on data with unprecedented speed and accuracy",
  ...
  industries: {
    ...
    items: [
      {
        title: "Smart City",
        desc: "Integrate traffic, environmental, and safety data across the city. Detect anomalies instantly and strengthen public safety.",
      },
      {
        title: "SOC (Security Operations)",
        desc: "AI-powered real-time analysis of thousands of camera feeds. Automatically detect intrusions and abnormal behavior.",
      },
      {
        title: "Smart Factory",
        desc: "Detect production defects and equipment anomalies in real time. Maximize uptime with predictive maintenance.",
      },
      {
        title: "Energy & Plant",
        desc: "Remote facility monitoring and thermal analysis to prevent safety incidents and improve operational efficiency.",
      },
      {
        title: "Data Center",
        desc: "Unified monitoring of server room environment, access control, and equipment status for zero-downtime operations.",
      },
      {
        title: "Transport & Logistics",
        desc: "Integrate real-time location and video from vehicles, drones, and ships to optimize logistics and prevent accidents.",
      },
    ],
  },
  about: {
    ...
    cards: [
      {
        title: "Cloud-Native",
        desc: "Designed for scalability from the ground up. Multi-region support, fault-tolerant architecture, and unlimited elasticity.",
      },
      {
        title: "Edge AI Processing",
        desc: "Real-time video analysis with sub-10ms latency. Intelligence runs directly at the edge.",
      },
      {
        title: "Enterprise Security",
        desc: "SOC 2 Type II certified with zero-trust architecture and end-to-end encryption.",
      },
      {
        title: "Instant Deployment",
        desc: "From onboarding to production in hours, a fully managed platform.",
      },
    ],
  },
  connecting: {
    ...
    phases: [
      {
        title: "Phase 1",
        desc: "Proven B2B platform for global enterprises (Cisco, etc.). Delivering enterprise-grade real-time video integration infrastructure.",
      },
      {
        title: "Phase 2",
        desc: "Expanding to intelligent infrastructure connecting all moving devices, vehicles, drones, ships, smart cities, LEO satellites, and 5G/LTE networks.",
      },
    ],
  },
  opint: {
  ...
  usecases: {
    ...
    cases: [
      {
        client: "Port of Singapore: Streamflow Optimization",
        category: "Logistics",
        desc: "Harmonizing 4,000+ autonomous sensor nodes into a singular editorial environment for 24/7 stress-testing.",
        image:
          "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=600&q=80",
        url: "https://n3n.co.kr/ko/psa",
      },
      {
        client: "Barcelona Smart Grid: Anomaly Suppression",
        category: "Urban Ops",
        desc: "Deploying Smart Alarm Intelligence to reduce false maintenance dispatch costs by 30% via IoT noise cancellation.",
        image:
          "https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=600&q=80",
        url: "https://n3n.co.kr/usecase",
      },
      {
        client: "Global Edge: Sovereign Data Guarding",
        category: "Data Centers",
        desc: "Implementing DTG protocols across 14 sovereign data hubs to ensure high-priority packet integrity.",
        image:
          "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&q=80",
        url: "https://n3n.co.kr/usecase",
      },
      {
        client: "Pharma H",
        category: "Production",
        desc: "GMP process visualization for deviation management and real-time temperature/humidity/pressure control",
        image:
          "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5581&lang=ko",
      },
      {
        client: "POSCO",
        category: "Production",
        desc: "Real-time Industrial IoT data visualization based on Big Data for global operations",
        image:
          "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5582&lang=ko",
      },
      {
        client: "H Semiconductor",
        category: "Production",
        desc: "Wafer Big Data map-linked process visualization for predictive maintenance and defect root cause analysis",
        image:
          "https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5583&lang=ko",
      },
      {
        ...
        desc: "Integrated IoT Device usage visualization as IoT Management Platform for telecom customers",
        image:
          "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5437&lang=ko",
      },
      {
        client: "AT&T Mexico",
        category: "Service Ops",
        desc: "Cell tower sensor data and CCTV integrated visualization for 24/7/365 unmanned remote monitoring",
        image:
          "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5440&lang=ko",
      },
      {
        client: "Carnival Cruise",
        category: "Service Ops",
        desc: "QoE visualization for real-time data control enabling personalized IoT services",
        image:
          "https://images.unsplash.com/photo-1548574505-5e239809ee19?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5446&lang=ko",
      },
      {
        client: "Jaipur, India",
        category: "Smart City",
        desc: "Integrated public infrastructure monitoring for real-time remote operations",
        image:
          "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5548&lang=ko",
      },
      {
        ...
        category: "Smart City",
        desc: "Real-time integrated administrative KPI-based smart city platform for transparency and efficiency",
        image:
          "https://images.unsplash.com/photo-1514924013411-cbf25faa35bb?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5542&lang=ko",
      },
      {
        client: "Songdo IBD",
        category: "Smart City",
        desc: "Smart city operations solution combining urban scenarios with visualized IoT data",
        image:
          "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5555&lang=ko",
      },
      {
        client: "Cisco ITRM",
        category: "IT Infra",
        desc: "Causal logic MAP visualization of complex IT infrastructure for instant root cause identification",
        image:
          "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5563&lang=ko",
      },
      {
        client: "H Motors",
        category: "Industrial",
        desc: "Fire prevention system integrating flame detection sensors with real-time video",
        image:
          "https://images.unsplash.com/photo-1565043666747-69f6646db940?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5426&lang=ko",
      },
      {
        client: "POSCO ICT",
        category: "Industrial",
        desc: "Full HD real-time production floor monitoring from central control room",
        image:
          "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5420&lang=ko",
      },
      {
        client: "S Metro",
        category: "Public Infra",
        desc: "Smart Connected Subway for remote intelligent management of operations and facilities",
        image:
          "https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5371&lang=ko",
      },
      {
        client: "KOEN",
        category: "Public Infra",
        desc: "Integration of 1,500+ CCTVs and sensor data reducing network and maintenance costs",
        image:
          "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5367&lang=ko",
      },
      {
        client: "Incheon Bridge",
        category: "Public Infra",
        desc: "Integrated traffic monitoring via CCTV, maps, weather, and detection/control systems",
        image:
          "https://images.unsplash.com/photo-1545893835-abaa50cbe628?w=600&q=80",
        url: "https://n3n.co.kr/?page_id=5381&lang=ko",
      },
  ...
  tech: {
    ...
    cards: [
      {
        label: "AI/ML Models",
        desc: "Custom-trained vision & anomaly detection models",
      },
      {
        label: "Edge Computing",
        desc: "Process data at source, 10x latency reduction",
      },
      {
        label: "Cloud Infra",
        desc: "Auto-scaling multi-region infrastructure",
      },
      {
        label: "MLOps Pipeline",
        desc: "Continuous model training & deployment",
      },
  ...
  vision: {
    ...
    steps: [
      {
        title: "Capture",
        desc: "Connect cameras, IoT sensors, and data streams from any source. INNOWATCH and WIZEYE simultaneously collect visible and invisible data.",
      },
      {
        title: "Analyze",
        desc: "AI vision engine processes video streams in real time, detecting objects, behaviors, and anomalies while converting IoT big data into structured insights.",
      },
      {
        title: "Unify",
        desc: "N3N Operation Intelligence core fuses INNOWATCH and WIZEYE data into a single unified intelligence layer.",
      },
      {
        title: "Act",
        desc: "Automated workflows trigger alerts, remediations, and business process apps, delivering Actionable Insight without human intervention.",
      },
    ],
    stats: [
  ...
  contact: {
    ...
    message: "Message",
    messagePh: "Tell us about your use case...",
  ...
  decision: {
    ...
    features: [
      {
        title: "Rules Engine",
        desc: "Classify and prioritize situations against your operating rules.",
      },
      {
        title: "Real-time Alerts",
        desc: "Deliver context-rich notifications to the right operator, instantly.",
      },
      {
        title: "Automated Actions",
        desc: "Trigger pre-defined response workflows without human delay.",
      },
    ],
    outputs: [
      "Incident Detection",
